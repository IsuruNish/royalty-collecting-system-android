    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    url = new URL("http://10.0.2.2:8080/OSCA_war_exploded/AndroidUpcomingPaymentsServlet");
...
//                        ArrayList<ArrayList<String>> newList = new ArrayList<>();
                    ...
                    if (newList.size() != 0){
                        ...
                        recyclerView.setLayoutManager(new LinearLayoutManager(PaymentDetails.this));
                    }
                    else{
                        Intent intent = new Intent(PaymentDetails.this, UpcomingBlank.class);
...
//                    recyclerView.setLayoutManager(new LinearLayoutManager(PaymentDetails.this));
    ...
    public void convertToArr(String str){
